const appName = 'GossipGo';
const searchBarHintText = 'Search Contacts';
const bottomBarChats = 'Chats';
const bottomBarStories = 'Stories';
...
const statusScreenAppBarTitle = 'Updates';
const createGroupScreenAppBarTitle = 'Create Group';
